...
func (a *RegionsApiService) RegionsRetrieveExecute(r ApiRegionsRetrieveRequest) (SupportedCloudRegion, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/regions/{providerName}"
	localVarPath = strings.Replace(localVarPath, "{"+"providerName"+"}", _neturl.PathEscape(parameterToString(r.providerName, "")), -1)
