...
type ApiMzVersionsLatestRetrieveRequest struct {
	ctx _context.Context
	ApiService *MzVersionsApiService
	track *string
}
...
func (r ApiMzVersionsLatestRetrieveRequest) Execute() (string, *_nethttp.Response, error) {
	return r.ApiService.MzVersionsLatestRetrieveExecute(r)
}

/*
 * MzVersionsLatestRetrieve Method for MzVersionsLatestRetrieve
 * Returns the latest version of Materialize.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiMzVersionsLatestRetrieveRequest
 */
...
func (a *MzVersionsApiService) MzVersionsLatestRetrieveExecute(r ApiMzVersionsLatestRetrieveRequest) (string, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MzVersionsApiService.MzVersionsLatestRetrieve")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mz-versions/latest"
...
type ApiMzVersionsListRequest struct {
	ctx _context.Context
	ApiService *MzVersionsApiService
}


func (r ApiMzVersionsListRequest) Execute() ([]string, *_nethttp.Response, error) {
	return r.ApiService.MzVersionsListExecute(r)
}
...
func (a *MzVersionsApiService) MzVersionsListExecute(r ApiMzVersionsListRequest) ([]string, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MzVersionsApiService.MzVersionsList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mz-versions"
